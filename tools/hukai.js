...
let 前言 = [
    "网友们对x一事的批评我认为有道理。",
    "x事件迅速聚集了互联网上的关注。我觉得这件事与当前的大局关系不太大。笔者我本人更关心的方向还是，为什么x事件发生得如此容易，是什么样的利益驱动导致了对风险的漠视？",
...
let 后语 = [
    ...
    "笔者作为高度关心x的媒体人，衷心希望x能解决。"
]

let 论述 = [
    "先前曝出的x事件为何招致大量负面舆情，就是因为x脱离了人们的平常心和世俗认知，过犹不及。",
    "到了本周晚些时候，另一则关于x的消息在网上突出出来。此消息强化了人们对先前公布的新闻所产生的联想。",
    ...
    "笔者不主张这时候将主要精力用来往后看。",
    "x的情况引起舆论强烈不满。除了舆论本身存在一些因x引起的怨气，也有其他的原因，笔者觉得x实在不应该。",
    "笔者作为媒体人在此呼吁所有相关人士要以x为鉴。",
    "可是，即使是这样，x的出现仍然代表了一定的意义。",
    "在这种不可避免的冲突下，笔者认为，我们必须解决这个问题。"
